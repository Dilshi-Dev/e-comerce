    ...
    <div class="sidebar" data-color="Green"> <!--Tip 1: You can change the color of the sidebar using: data-color="blue | green | orange | red | yellow" -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="<?php echo e('deliverymanager'==request()->path() ? 'active':''); ?>">
          ...
          <li>
          <li class="<?php echo e('ordermanager'==request()->path() ? 'active':''); ?>">
            <a href="/ordermanager">
            <i class="now-ui-icons education_atom"></i>
              <p>Finance Manager</p>
            </a>
          ...
          <li>
          <li class="<?php echo e('itemmanager'==request()->path() ? 'active':''); ?>">
            <a href="/itemmanager">
...
</html><?php /**PATH C:\Users\User\Desktop\E-Mart\e-mart\resources\views/layouts/admin.blade.php ENDPATH**/ ?>